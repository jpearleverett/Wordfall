...
export function MagnifierIcon({ size = 24, accent = '#00e5ff' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      ...
      <Circle cx="10" cy="10" r="6.6" fill="none" stroke={`url(#${id})`} strokeWidth="2.6" />
      <Path d="M15 15l6 6" stroke={`url(#${id})`} strokeWidth="3" strokeLinecap="round" />
...
export function ChatIcon({ size = 24, accent = '#00f5d4' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M12 3.4c5.4 0 9.4 3.2 9.4 7.5s-4 7.5-9.4 7.5c-1 0-2-.1-2.9-.4L4.6 20l1.2-3.4c-1.9-1.4-3.2-3.4-3.2-5.7 0-4.3 4-7.5 9.4-7.5Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Circle cx="8" cy="11" r="1.2" fill={shade(accent, -78)} />
      <Circle cx="12" cy="11" r="1.2" fill={shade(accent, -78)} />
      <Circle cx="16" cy="11" r="1.2" fill={shade(accent, -78)} />
    </Svg>
  );
}
...
export function PeopleIcon({ size = 24, accent = '#c84dff' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Circle cx="15.2" cy="8" r="3.6" fill={shade(accent, -22)} stroke={rim(accent)} strokeWidth="1.2" />
      <Path d="M9.4 20.4c0-3.6 2.6-6 5.8-6s5.8 2.4 5.8 6Z" fill={shade(accent, -22)} stroke={rim(accent)} strokeWidth="1.2" strokeLinejoin="round" />
      <Circle cx="8.4" cy="8.8" r="3.9" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.3" />
      <Path d="M2 21c0-3.9 2.8-6.5 6.4-6.5s6.4 2.6 6.4 6.5Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.3" strokeLinejoin="round" />
    </Svg>
  );
}
...
export function HandshakeIcon({ size = 24, accent = '#ffb800' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M2.4 7.2 7 5.4l5 2 4.6-2 5 1.8v7.6l-2.4.8" fill="none" stroke={shade(accent, -30)} strokeWidth="1.7" strokeLinejoin="round" />
      <Path d="M2.4 14.8V7.2M12 7.4 8.6 10.6a1.7 1.7 0 0 0 2.4 2.4l2-1.9 5.4 4.6a1.6 1.6 0 0 1-2 2.5l-.9-.7a1.6 1.6 0 0 1-2.2 2.1l-1-.8a1.6 1.6 0 0 1-2.3 1.9l-3.4-2.6-1.2.5" fill="none" stroke={`url(#${id})`} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
...
export function BrainIcon({ size = 24, accent = '#ff6ec7' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M11.2 3.2a3.2 3.2 0 0 0-3.7 1.5A3.4 3.4 0 0 0 4.4 8a3.5 3.5 0 0 0-1 5.9 3.4 3.4 0 0 0 2.3 4.6c.4 1.6 1.9 2.7 3.6 2.5 1-.1 1.9-.8 1.9-1.9V4.6c0-.7-.4-1.2-1-1.4Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.3" strokeLinejoin="round" />
      <Path d="M12.8 3.2a3.2 3.2 0 0 1 3.7 1.5A3.4 3.4 0 0 1 19.6 8a3.5 3.5 0 0 1 1 5.9 3.4 3.4 0 0 1-2.3 4.6c-.4 1.6-1.9 2.7-3.6 2.5-1-.1-1.9-.8-1.9-1.9V4.6c0-.7.4-1.2 1-1.4Z" fill={shade(accent, -18)} stroke={rim(accent)} strokeWidth="1.3" strokeLinejoin="round" />
      <Path d="M8.8 8.2c-1 .3-1.7.9-2 1.8M15.2 12.4c1 .3 1.7.9 2 1.8" stroke={rim(accent)} strokeWidth="1" strokeLinecap="round" fill="none" />
    </Svg>
  );
}
...
export function PuzzleIcon({ size = 24, accent = '#35b892' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M9.6 3.6a2 2 0 0 1 4 0v1h3.8a1.4 1.4 0 0 1 1.4 1.4v3.6h1a2 2 0 0 1 0 4h-1v4.8a1.4 1.4 0 0 1-1.4 1.4h-4.2v-1.2a1.8 1.8 0 0 0-3.6 0v1.2H5.4A1.4 1.4 0 0 1 4 18.4v-4h1.2a1.8 1.8 0 0 0 0-3.6H4V6a1.4 1.4 0 0 1 1.4-1.4h4.2Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Path d="M6.2 6.4h3" stroke={HILITE} strokeWidth="1.3" strokeLinecap="round" />
    </Svg>
  );
}
...
export function GearIcon({ size = 24, accent = '#c9d2e8' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M10.3 2.6h3.4l.5 2.6c.7.2 1.3.6 1.9 1l2.5-.9 1.7 3-2 1.8a7 7 0 0 1 0 2.2l2 1.8-1.7 3-2.5-.9c-.6.4-1.2.8-1.9 1l-.5 2.6h-3.4l-.5-2.6c-.7-.2-1.3-.6-1.9-1l-2.5.9-1.7-3 2-1.8a7 7 0 0 1 0-2.2l-2-1.8 1.7-3 2.5.9c.6-.4 1.2-.8 1.9-1Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.3" strokeLinejoin="round" />
      <Circle cx="12" cy="12" r="3.1" fill={shade(accent, -75)} stroke={rim(accent)} strokeWidth="1.1" />
    </Svg>
  );
}
...
export function ShieldIcon({ size = 24, accent = '#31a6e8' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M12 2.2 20.2 5v6.4c0 5.2-3.3 8.6-8.2 10.4C7.1 20 3.8 16.6 3.8 11.4V5Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Path d="M12 4.6v14.6" stroke={shade(accent, -48)} strokeWidth="1.1" />
...
export function HouseIcon({ size = 24, accent = '#ff7a1a' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M12 3 2.8 10.8h2.4V21h13.6V10.8h2.4Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Rect x="9.9" y="14.2" width="4.2" height="6.8" rx="0.8" fill={shade(accent, -68)} stroke={rim(accent)} strokeWidth="1" />
      <Rect x="6.4" y="12" width="2.4" height="2.4" rx="0.5" fill="#ffd24d" stroke={rim(accent)} strokeWidth="0.8" />
      <Rect x="15.2" y="12" width="2.4" height="2.4" rx="0.5" fill="#ffd24d" stroke={rim(accent)} strokeWidth="0.8" />
    </Svg>
  );
}
...
export function GamepadIcon({ size = 24, accent = '#ff2d95' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M7 6.4h10a6.4 6.4 0 0 1 6.3 7.6c-.4 2.2-1.6 3.8-3.3 3.8-1.3 0-2.2-.8-3-1.9-.6-.8-1.1-1.1-2-1.1h-6c-.9 0-1.4.3-2 1.1-.8 1.1-1.7 1.9-3 1.9-1.7 0-2.9-1.6-3.3-3.8A6.4 6.4 0 0 1 7 6.4Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Path d="M8 9.6v4.2M5.9 11.7h4.2" stroke="#f5f0ff" strokeWidth="1.7" strokeLinecap="round" />
      <Circle cx="15.4" cy="12.9" r="1.2" fill="#00e5ff" stroke={rim(accent)} strokeWidth="0.7" />
      <Circle cx="17.8" cy="10.5" r="1.2" fill="#ffd24d" stroke={rim(accent)} strokeWidth="0.7" />
    </Svg>
  );
}
...
export function PencilIcon({ size = 24, accent = '#ffb800' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M16.4 3.4a2.4 2.4 0 0 1 3.4 0l.8.8a2.4 2.4 0 0 1 0 3.4L8.8 19.4 3.4 20.6 4.6 15.2Z" fill={`url(#${id})`} stroke={rim(accent)} strokeWidth="1.4" strokeLinejoin="round" />
      <Path d="M14.6 5.2l4.2 4.2" stroke={rim(accent)} strokeWidth="1.2" />
      <Path d="M4.6 15.2l4.2 4.2" stroke={rim(accent)} strokeWidth="1.2" />
      <Path d="M4.3 18.2l1.5 1.5-2.4.9Z" fill={shade(accent, -80)} />
    </Svg>
  );
}
...
export function LinkIcon({ size = 24, accent = '#00e5ff' }: IconProps) {
  ...
  return (
    <Svg width={size} height={size} viewBox={VB}>
      <BodyGrad id={id} color={accent} />
      <Path d="M10 14 14 10M8.4 11.2 5.6 14a4 4 0 0 0 5.7 5.7l2.7-2.9M15.6 12.8l2.8-2.8a4 4 0 0 0-5.7-5.7L10 7.2" fill="none" stroke={`url(#${id})`} strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  );
}
