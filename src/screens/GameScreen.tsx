...
const styles = StyleSheet.create({
  ...
  timerBar: {
    backgroundColor: 'rgba(23, 20, 62, 0.74)',
    paddingVertical: 8,
    ...
    marginBottom: 6,
    borderWidth: 1.2,
    borderColor: 'rgba(102, 244, 255, 0.28)',
  },
  timerBarDanger: {
  ...
  boosterShelfBar: {
    ...
    borderRadius: 18,
    borderWidth: 1,
    borderColor: 'rgba(184,220,255,0.18)',
  },
  boosterShelf: {
    flexDirection: 'row',
    justifyContent: 'center',
  ...
  boosterButton: {
    ...
    borderRadius: 16,
    borderWidth: 1.2,
    borderColor: 'rgba(126, 234, 255, 0.26)',
    minWidth: 116,
    minHeight: 94,
    overflow: 'visible',
    shadowColor: 'rgba(0, 212, 255, 0.32)',
  ...
  boosterGlow: {
    position: 'absolute',
    top: -8,
    left: '14%' as unknown as number,
    right: '14%' as unknown as number,
    height: 64,
    borderRadius: 24,
  },
  boosterIconWrap: {
    ...
    borderRadius: 14,
    borderWidth: 1,
    borderColor: 'rgba(191, 221, 255, 0.24)',
    alignItems: 'center',
    justifyContent: 'center',
    marginBottom: 10,
    backgroundColor: 'rgba(23, 16, 60, 0.68)',
  },
  boosterLabel: {
    fontFamily: FONTS.bodyBold,
    color: '#d4d9ff',
